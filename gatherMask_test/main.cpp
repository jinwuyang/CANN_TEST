...
extern "C" void gatherMask_do(uint32_t blockDim, void *stream, uint8_t *x, uint8_t *y, uint8_t *z);
...
int main() {
    ...
    std::vector<uint32_t> host_src1 = generate_uint32_data(1024);   
    std::vector<uint32_t> host_dst(1024);
    ...
    gatherMask_do(blockDim, stream, (uint8_t*)device_src0, (uint8_t*)device_src1, (uint8_t*)device_dst);
